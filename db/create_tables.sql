create table if not exists temp_support_applying_0
(
  ind varchar(10),
  name varchar(40),
  age int,
  family_members varchar(10),
...
create table if not exists village_allowance_bak_0
(
  ind varchar(10),
  ...
  allowances_people_mount varchar(20),
...
create table if not exists village_5allowance_register_0
(
  ind varchar(10),
...
create table if not exists medical_assistance_register_0
(
  ind varchar(10),
  name varchar(10),
  sex varchar(10),
...
create table if not exists city_allowance_register_0
(
  ind varchar(10),
  name varchar(20),
...
create table if not exists orphan_register_0
(
  ind varchar(10),
  name varchar(10),
  sex varchar(10),
  ...
  support_fee_end_time varchar(20),
  category varchar(20),
